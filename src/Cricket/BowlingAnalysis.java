...
public class BowlingAnalysis {
    public void BowlerStatistics(SpinBowler[] spinBowlers,
            FastMediumBowler[] fastMediumBowlers, FastBowler[] fastBowlers, int spinBowlersNumber,
        ...
        for (iterator = 0; iterator < spinBowlersNumber; iterator++) {
            ...
            spinBowlers[iterator].averageSpeed = spinBowlers[iterator].totalSpeed
                    / (spinBowlers[iterator].totalOver * 6);

            // add data and information
            matchDescription += "Name : " + spinBowlers[iterator].name + iEnd + "Total Overs: "
                    + spinBowlers[iterator].totalOver + ", Avg Speed: " + spinBowlers[iterator].averageSpeed + iEnd;

            System.out.println("Name : " + spinBowlers[iterator].name);
            System.out.println("Total Overs: " + spinBowlers[iterator].totalOver + ", Avg Speed: "
                    + spinBowlers[iterator].averageSpeed);
            System.out.println();
        }
        ...
        for (iterator = 0; iterator < fastMediumBowlersNumber; iterator++) {
            ...
            fastMediumBowlers[iterator].averageSpeed = fastMediumBowlers[iterator].totalSpeed
                    / (fastMediumBowlers[iterator].totalOver * 6);
            // add data and information
            matchDescription += "Name : " + fastMediumBowlers[iterator].name + iEnd + "Total Overs: "
                    + fastMediumBowlers[iterator].totalOver + ", Avg Speed: " + fastMediumBowlers[iterator].averageSpeed
                    + iEnd;

            System.out.println("Name : " + fastMediumBowlers[iterator].name);
            System.out.println("Total Overs: " + fastMediumBowlers[iterator].totalOver + ", Avg Speed: "
                    + fastMediumBowlers[iterator].averageSpeed);
            System.out.println();
        }
        ...
        for (iterator = 0; iterator < fastBowlersNumber; iterator++) {
            ...
            fastBowlers[iterator].averageSpeed = fastBowlers[iterator].totalSpeed
                    / (fastBowlers[iterator].totalOver * 6);
            // add data and information
            matchDescription += "Name : " + fastBowlers[iterator].name + iEnd + "Total Overs: "
                    + fastBowlers[iterator].totalOver + ", Avg Speed: " + fastBowlers[iterator].averageSpeed + iEnd;

            System.out.println("Name : " + fastBowlers[iterator].name);
            System.out.println("Total Overs: " + fastBowlers[iterator].totalOver + ", Avg Speed: "
                    + fastBowlers[iterator].averageSpeed);
            System.out.println();
        }
